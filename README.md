...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/wenzadev
```

A live public deployment of this template is available at [https://wenzadev.templates.workers.dev](https://wenzadev.templates.workers.dev)
